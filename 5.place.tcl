...
# ####################
#changed -place_global_timing_effort from medium and -place_global_activity_power_driven_effort from standard
setPlaceMode -place_global_cong_effort high -place_global_solver_effort high -place_global_timing_effort high -place_global_activity_power_driven true -place_global_activity_power_driven_effort high -place_global_uniform_density true -place_global_align_macro true -place_global_clock_power_driven true -place_global_clock_power_driven_effort high

setDesignMode -topRoutingLayer 10 -powerEffort high
